"""
Django settings for PO Management System
"""
...
# SECURITY
SECRET_KEY = config('SECRET_KEY', default="django-insecure-)r!p^1%h2ew#j^z(=^n+&zxjpe@*75q(*o&nf*#do&!^(dh#")
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='po_management'),
